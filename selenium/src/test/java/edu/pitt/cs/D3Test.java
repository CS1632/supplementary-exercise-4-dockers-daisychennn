...
public class D3Test {
  ...
  public void tEST3CATALOG() {
    ...
    driver.findElement(By.linkText("Catalog")).click();
    {
      ...
      vars.put("secondImg", attribute);
    }
    assertEquals("http://localhost:8080/images/cat2.jpg", vars.get("secondImg").toString());
  }
  @Test
  public void tEST4LISTING() {
    ...
    js.executeScript("document.cookie = \"1=false\";document.cookie = \"2=false\";document.cookie = \"3=false\";");
    driver.findElement(By.linkText("Catalog")).click();
    vars.put("list", driver.findElements(By.xpath("/html/body/div/main/div[1]/div/ul//li")).size());
